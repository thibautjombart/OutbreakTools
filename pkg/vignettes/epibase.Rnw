...
The output of the function is a list containing the SIR dynamics (\texttt{x\$dynamics}), an
...
@
This warning makes sense: in this dataset, there is simply too much information for us to visualize
it alltogether.
